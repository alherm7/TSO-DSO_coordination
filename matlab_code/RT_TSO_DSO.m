function [RT_outcome] = RT_TSO_DSO(data_tso,p_gen_DA_hat,p_dem_DA_hat,p_DR_DA_hat,wind_DA_hat,s,iter,kk)
...
% end
disp(['WPP: ' num2str(kk) ', Benders sub-prob. It.: ' num2str(iter) ', Scenario: ' num2str(s) ', Status : ' cvx_status])
...
RT_outcome.lambda_RT = lambda;

RT_outcome.tfin_subprob = tfin_subprob;
end
